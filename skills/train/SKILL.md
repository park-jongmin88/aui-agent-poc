---
name: train
description: "현재 작업 폴더의 run.py를 실행해 모델을 학습하고 MLflow에 등록한다. 작업 순서 4단계. 다음과 같은 요청에 사용: '학습해줘', '학습 시작해줘', '실행해줘', '돌려줘', 'MLflow에 등록해줘', '훈련시켜줘', '모델 학습시켜줘', '바로 학습할게', '로컬 테스트 건너뛰고 학습해줘' 영어/추가 표현: '트레인', 'train', 'run', '러닝', '모델 만들어줘', '본 학습', 'mlflow 올려줘', '학습 돌려'."
---
