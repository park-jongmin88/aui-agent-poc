---
name: init
description: "workspace/models/ 하위 폴더를 분석해 run.py를 생성한다. 작업 순서 1단계. 다음과 같은 요청에 사용: '준비해줘', '시작해줘', '폴더 분석해줘', '작업 시작', '학습 준비해줘', 'sklearn_sample로 시작해줘', '1번 폴더로 해줘', '처음부터 시작할게', '폴더 목록 보여줘', '모델 목록', '작업 목록', '어떤 폴더 있어', '뭐 있어', '/list'."
---
